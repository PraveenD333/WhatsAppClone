...
const UserDetails = () => {
  ...
  useEffect(() => {
    ...
    if (showNameEmoji || showAboutEmoji) {
      ...
      <motion.div
        ...
        <div className='w-full rounded-lg p-6'>
          ...
          <div className='space-y-6'>
            ...
            {/* Name Edit  */}
            <div className={`relative p-4 ${theme === "dark" ? "bg-gray-800" : "bg-white"} rounded-lg shadow-sm`}>
              <label
                htmlFor='name'
              ...
              <div className='flex items-center'>
                {isEditingName ? (
                  <input
                    ...
                    className={`w-full px-3 py-2 border rounded-md focus:outline-none foucus:ring-2 focus:ring-green-500 ${theme === "dark" ? "bg-gray-700 text-white" : "bg-white text-black"}`} />
