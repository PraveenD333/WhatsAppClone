...
const Sidebar = () => {
  ...
  const SidebarContent = (
    ...
    ${activeTab === "chats" ? theme === "dark" ? "text-gray-800" : "" : theme === "dark" ? "text-gray-300" : "text-gray-800"}`} />
      </Link>
    ...
    ${activeTab === "status" ? theme === "dark" ? "text-gray-800" : "" : theme === "dark" ? "text-gray-300" : "text-gray-800"}`} />
      </Link>
      ...
      <Link to='/user-profile'
        ...
        {user?.profilePicture ? (<img src={user.profilePicture} alt='user' className='h-6 w-6 rounded-full' />) : (
          <FaUserCircle className={`h-6 w-6  
        ${activeTab === "profile" ? theme === "dark" ? "text-gray-800" : "" : theme === "dark" ? "text-gray-300" : "text-gray-800"}`} />
        )}
      </Link>
  ...
  return (
    ...
    ${theme === "dark" ? "bg-gray-800 border-gray-400" : "bg-[rgb(239,242,254)] border-gray-400"}
